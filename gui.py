...
def create_ui(manager):
    button_lapiz = pygame_gui.elements.UIButton(
        relative_rect=pygame.Rect((10, 10), (100, 30)),
        text='Lápiz',
        manager=manager
    )
    button_circulo = pygame_gui.elements.UIButton(
        relative_rect=pygame.Rect((120, 10), (100, 30)),
        text='Círculo',
        manager=manager
    )
    button_limpiar = pygame_gui.elements.UIButton(
    ...
    return {
        'lapiz': button_lapiz,
        'circulo': button_circulo,
        'limpiar': button_limpiar
    }
